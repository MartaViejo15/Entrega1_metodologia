...
public class TestMyTriangle {
    public static void main(String[] args) {
        ...
        MyTriangle triangle3 = new MyTriangle(new MyPoint(0,0), new MyPoint(0, 0), new MyPoint(0,0));
        ...
        System.out.println("Triangle 5 type: " + triangle5.getType());  // isosceles
        MyTriangle triangle6 = new MyTriangle(new MyPoint(0, 0), new MyPoint(1, 1), new MyPoint(2, 2));
        System.out.println("Triangle 6 type: " + triangle6.getType()); // Scalene
    }
}
